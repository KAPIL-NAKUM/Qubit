  ...
  <table border="1">
    ...
    <%
      ...
      try {
          Class.forName("com.mysql.jdbc.Driver");
          Connection connection = DriverManager.getConnection(jdbcURL, dbUser, dbPassword);
          String sql = "SELECT p.ProjectName, p.ProjectDescription, p.Employee, d.FileID, d.FileName " +
                       "FROM Project p " +
          ...
          while (result.next()) {
              ...
              project.setProjectDescription(result.getString("ProjectDescription"));
              project.setEmployee(result.getString("Employee"));
              project.setFileId(result.getInt("FileID"));
              project.setFileName(result.getString("FileName"));
      ...
      List<ProjectDetails> projects = (List<ProjectDetails>) request.getAttribute("projects");
      if (projects != null) {
